...
export default function Home() {
  return (
    <div>
      ...
      <div className=" bg-slate-200 max-h-screen py-6 px-60 mb-60">
          <div className="flex justify-between">
            <h3 className="text-2xl font-semibold">Featured New Cars</h3>
        ...
        <div className="flex justify-center space-x-12 items-center pt-10">

          <div className="bg-white h-72 w-56">
            <Link href="/Toyota-Fortuner" title="New Toyota Fortuner">
            <Image
            src="/Fortuner.PNG"
            alt="Fortuner"
            width={230}
            ...
            <div className="text-green-500 text-center text-sm">PKR 1.45 - 1.99 Crore</div>
              <div className="flex justify-center items-center pt-3">
                <svg className="w-4 h-4 text-yellow-300 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                      ...
                      <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                  </svg><svg className="w-4 h-4 text-slate-300 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                      <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                  </svg> 
                  <div className="flex justify-center px-2">
                      <p className="flex text-slate-400">42 Reviwes</p>
                </div>
              </div>
          </div>
          ...
          <div className="bg-white h-72 w-56">
            ...
            <div className="text-green-500 text-center text-sm">PKR 59.7 - 75.5 Lacs</div>
              <div className="flex justify-center items-center pt-3">
                <svg className="w-4 h-4 text-yellow-300 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                      <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                  </svg><svg className="w-4 h-4 text-yellow-300 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                  ...
                  <div className="flex justify-center px-2">
                      <p className="flex text-slate-400">622 Reviwes</p>
                </div>
              </div>
          </div>
          ...
          <div className="bg-white h-72 w-56">
            ...
            <div className="text-green-500 text-center text-sm">PKR 23.3 - 30.5 Lacs</div>
              <div className="flex justify-center items-center pt-3">
                <svg className="w-4 h-4 text-yellow-300 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                      <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                  </svg><svg className="w-4 h-4 text-yellow-300 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                  ...
                  <div className="flex justify-center px-2">
                      <p className="flex text-slate-400">199 Reviwes</p>
                </div>
              </div>
          </div>

          <div className="bg-white h-72 w-56">
            <Link href="Honda-Civic" title="New Honda Civic">
              <Image 
              src="/honda.jpg"
              alt="Honda Civic"
              width={230}
            ...
            <div className="text-green-500 text-center text-sm">PKR 86.6 - 99.0 Lacs</div>
              <div className="flex justify-center items-center pt-3">
                <svg className="w-4 h-4 text-yellow-300 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                      <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                  </svg><svg className="w-4 h-4 text-yellow-300 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                  ...
                  <div className="flex justify-center px-2">
                      <p className="flex text-slate-400">360 Reviwes</p>
                </div>
              </div>
          </div>
